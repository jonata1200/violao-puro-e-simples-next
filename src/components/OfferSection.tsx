...
import { HOTMART_CHECKOUT_URL, PRICING } from '@/lib/constants';
            ...
            <div className="relative">
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm border border-primary-500/30 rounded-3xl p-8">
                ...
                <div className="text-center border-t border-gray-700 pt-8">
                  <p className="text-gray-400 line-through text-lg mb-3">De {PRICING.fromPrice}</p>
                  <div className="mb-6">
                    <span className="text-5xl font-bold text-primary-500">{PRICING.price}</span>
                    <p className="text-gray-300 text-sm mt-2">{PRICING.priceNote}</p>
                  </div>

                  <div className="bg-gradient-to-r from-primary-500/20 to-primary-600/20 p-6 rounded-2xl border border-primary-500/40 mb-6">
                    <p className="text-3xl font-bold text-primary-400 mb-2">ou {PRICING.installment}</p>
                    <p className="text-sm text-gray-300">{PRICING.installmentNote}</p>
                  </div>

                  <a href={HOTMART_CHECKOUT_URL} target="_blank" rel="noopener noreferrer" className="block mb-6">
