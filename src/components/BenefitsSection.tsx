...
export function BenefitsSection() {
    const benefits = [
        ...
        },
        {
          ...
          gradientClasses: "from-purple-500/20 to-purple-600/20"
        },
        {
          icon: Guitar,
          ...
          gradientClasses: "from-green-500/20 to-green-600/20"
        },
        {
          icon: Award,
          ...
          gradientClasses: "from-primary-500/20 to-primary-600/20"
        }
      ];
        ...
        <Grid cols={1} colsMd={2} colsLg={4} gap={8} className="max-w-7xl mx-auto">
          {benefits.map((benefit, index) => (
            <div key={index} className="group relative">
              <div className={cn(
                "absolute -inset-4 bg-gradient-to-br rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",
