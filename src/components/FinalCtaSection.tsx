        ...
        <div className="bg-gradient-to-br from-gray-900 to-black p-10 rounded-3xl max-w-2xl lg:max-w-5xl mx-auto mb-16 border-2 border-primary-500/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <p className="text-gray-400 line-through text-xl mb-2">De {PRICING.fromPrice}</p>
              <div className="mb-4">
                <p className="text-5xl font-bold text-primary-500 mb-2">{PRICING.price}</p>
                <p className="text-sm text-gray-400 mb-4">{PRICING.priceNote}</p>
              </div>
              <div className="bg-primary-500/20 border border-primary-500/30 rounded-xl p-4 mb-4">
                <p className="text-2xl font-bold text-primary-400 mb-1">ou {PRICING.installment}</p>
