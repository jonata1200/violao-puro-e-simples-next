...
export function CookieBanner() {
  ...
  const handleReject = () => {
    // Recusa registrada: banner some e cookies de terceiros não são essenciais.
        ...
        <Flex direction="col" justify="between" align="center" className="md:flex-row gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              ...
              className="border border-gray-600 text-gray-300 font-semibold px-5 py-2 rounded-lg hover:border-gray-400 hover:text-white transition-colors"
            >
              Recusar
            </button>
            <button
              onClick={handleAccept}
              className="bg-primary-500 text-black font-bold px-6 py-2 rounded-lg hover:bg-primary-600 transition-colors"
            >
              Aceitar e Fechar
            </button>
          </div>
